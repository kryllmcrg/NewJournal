          ...
          <ul class="comments-list">
            <li>
              <div class="comment d-flex">
                <img loading="lazy" class="comment-avatar" alt="author" src="assets/images/news/avator1.png">
              ...
              <ul class="comments-reply">
                <li>
                  <div class="comment d-flex">
                    <img loading="lazy" class="comment-avatar" alt="author" src="assets/images/news/avator2.png">
                    <div class="comment-body">
                      <div class="meta-data">
              ...
              <div class="comment d-flex last">
                <img loading="lazy" class="comment-avatar" alt="author" src="assets/images/news/avator3.png">
                <div class="comment-body">
                  <div class="meta-data">
